...
//specification to Oracle 8

# common optimization rule for Oracle 8
# uncomment this line if this optimisation is needed on your system
#
# sqlBase.templates['select'] = 'SELECT /*+ RULE */ #1 FROM #2'

# syntax to create an alias of a table. #1=real table name, #2=alias name
syntax['alias'] = '#1 #2';
binaryCOP['ora_left_join'] = "(+) =";
