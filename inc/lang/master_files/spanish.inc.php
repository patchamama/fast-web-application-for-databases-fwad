...
//
// $Id: spanish.inc.php,v 1.2.2.1 2004/11/07 08:31:44 lbrueckner Exp $

// strings used for the tabfolder menu
$menu_strings = array('db'   => 'Datos generales',   
                      'don'     => 'Donante',     
                      'loc'=> 'Localidad',
                      );

// the coordinates for the image area used by the tabfolder menu
$menu_coords = array('db'   => '8,0,122,35',
                     'don'     => '124,0,179,35',
                     'loc'=> '181,0,269,35',
                     );
...
$ptitle_strings = array('info'        => 'Infomacion', 
                        ...
                        'dt_csv'      => 'Importacion/Exportacion CSV',
                        'usr_user'    => 'Usuarios',
                        'usr_role'    => 'Roles',
                        'usr_grant'   => 'Grants',
...
$usr_strings = array('CreateUsr' => 'Crear Usuario',
                     'ModUser'   => 'Modificar Usuario %s',
...
$MESSAGES = array('BLOB_BROKEN_INFO'      => "La version de PHP no soporta Campos Blob(pelo menos no php4.0.2 e php4.0.3).<br>\n"
                  ...
                  'DELETE_CON_DB'         => "No se puede borrar una BD en uso. o ibWebaAdmin no se está conectando a %s.<br>Por favor intente nuevamente.<br>\n",
                  'CSV_IMPORT_COUNT'      => "%1\$d lineas importadas para la tabla %2\$s<br>\n",
                  'CONFIRM_TABLE_DELETE'  => 'Realmente desea Borrar la tabla %s?',
                  'CONFIRM_COLUMN_DELETE' => 'Realmente desea Borrar la Columna %1$s da tabla %2$s?',
                  ...
                  'CONFIRM_USER_DELETE'   => 'Realmente desea Borrar el Usuario %s?',
                  ...
                  'DATA_DONT_FOUND'	  => 'No fueron encontrados datos...'
                  );
...
$WARNINGS = array('CAN_NOT_EXPORT_BLOBS'  => "Los campos Blob de la tabla que seleciono estan omitidos.<br>\n"
                  ...
                  'NEED_SYSDBA_PW'        => "La contraseña de SYSDBA's es requerida para crear, modificar o Borrar Usuarios.<br>\n",
...
$ERRORS   = array('CREATE_DB_FAILED'      => 'Error intentando crear Base de Datos <b>%s</b> falhou!',
                  'NO_DB_SELECTED'        => 'Selecione un nombre de base de Datos primero!<br>',
                  'WRONG_DB_SUFFIX'       => 'Un nombre de Base de Datos debe ser terminado con <b>%s</b>',
                  'DB_NOT_ALLOWED'        => 'Acesso a <b>%s</b> no permitido.<br>'
                                             .'(verifique $ALLOWED_FILES e $ALLOWED_DIRS en inc/configuration.php)',
                  'NO_IBASE_MODULE'       => '<b>Su instalacion de php no soporta Firebird!</b><br>'
                  ...
                  'NO_AUTHENTICATION'	  => 'No se será posible acceder a la base de datos sin identificarse.',
                  'PARAMS_UNKNOWN' 	  => 'No puedes acceder a este archivo directamente...',
                  'NO_FILE_CONFIGURATION' => 'No se encuentra el archivo de configuración...'
                  );
