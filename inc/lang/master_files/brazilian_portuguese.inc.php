...
//
// $Id: brazilian_portuguese.inc.php,v 1.21.2.1 2004/11/07 08:31:42 lbrueckner Exp $
...
$ptitle_strings = array('info'        => 'Informações',
                        ...
                        'dt_csv'      => 'Importação/Exportação CSV',
                        'usr_user'    => 'Usuários',
                        'usr_role'    => 'Roles',
                        'usr_grant'   => 'Grants',
...
$MESSAGES = array('BLOB_BROKEN_INFO'      => "O suporte à Blobs está quebrado (pelo menos no php4.0.2 e php4.0.3).<br>\n"
                  ...
                  'DELETE_CON_DB'         => "Você não pode apagar um banco de dados em uso. Agora o ibWebaAdmin não está mais conectado à %s.<br>Por favor tente novamente.<br>\n",
