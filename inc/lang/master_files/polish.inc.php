...
//
// $Id: polish.inc.php,v 1.1.2.2 2004/11/07 08:31:43 lbrueckner Exp $
...
$ptitle_strings = array('info'        => 'Informacje', 
                        ...
                        'dt_csv'      => 'Import/Eksport danych CSV',
...
$adm_strings = array('SysdbaPW'  => 'Has³o SYSDBA',
                     ...
                     'PConnect'  => 'Skonfigurowa³eœ PERSISTENT_CONNECTION=TRUE, to prowadzi do zak³uceñ.',
                     'Rescind'   => 'Rescind Shutdown',
                     'BTarget'   => 'Utwórz kopiê zapasow¹ celu',
                     'FDName'    => 'Nazwa pliku lub urz¹dzenia',
                     'ServiceMgr'=> 'Mened¿er serwisu',
                     'BlFactor'  => 'Wspó³czynnik blokowania',
                     'Options'   => 'Opcje',
                     'BConvert'  => 'Konwertuj zewnêtrzne pliki jako wewnêtrzne tabele',
                     'BCreate'   => 'Utwórz nieskompresowan¹ kopiê zapasow¹',
...
$MESSAGES = array('BLOB_BROKEN_INFO'      => "Wsparcie dla Blobów jest zepsute (przynajmniej w php4.0.2 i php4.0.3).<br>\n"
                  ...
                  'DELETE_CON_DB'         => "Nie mo¿esz usun¹æ bazy danych, która jest aktualnie w u¿yciu. Teraz ibWebaAdmin nie jest ju¿ pod³¹czony do %s.<br>Proszê spróbowaæ ponownie.<br>\n",
