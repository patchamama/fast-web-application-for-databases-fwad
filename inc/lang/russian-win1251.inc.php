...
//
// $Id: russian-win1251.inc.php,v 1.6.2.1 2004/11/07 08:31:43 lbrueckner Exp $
...
$ptitle_strings = array('info'        => 'Состояние', 
                        ...
                        'dt_csv'      => 'Импорт/Экспорт файла CSV',
...
$adm_strings = array('SysdbaPW'  => 'пароль пользователя SYSDBA',
                     ...
                     'PConnect'  => 'Вы установили PERSISTENT_CONNECTION=TRUE, это может вызвать сбой.',
                     'Rescind'   => 'Отменить выключение',
                     'BTarget'   => 'Резервная копия',
                     'FDName'    => 'Имя файла или устройства',
                     'ServiceMgr'=> 'Сервис-менеджер',
                     'BlFactor'  => 'Фактор блокировки',
                     'Options'   => 'Опции',
                     'BConvert'  => 'Конвертировать внешние файлы во внутренние таблицы',
                     'BCreate'   => 'Создавать несжатую копию',
...
$MESSAGES = array('BLOB_BROKEN_INFO'      => "Поддержка blob не работает (по крайней мере в php4.0.2 и php4.0.3).<br>\n"
                  ...
                  'DELETE_CON_DB'         => "Нельзя удалить использующуюся базу данных. Теперь ibWebAdmin отсоединён от %s.<br>Пожалуйста, попробуйте снова.<br>\n",
