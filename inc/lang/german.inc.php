...
//
// $Id: german.inc.php,v 1.28.2.1 2004/11/07 08:31:42 lbrueckner Exp $
...
$ptitle_strings = array('info'        => 'Info', 
                        ...
                        'dt_csv'      => 'CSV-Dateien importieren/exportieren',
                        'usr_user'    => 'Benutzer',              
                        'usr_role'    => 'Rollen',              
...
$adm_strings = array('SysdbaPW'  => 'SYSDBA Passwort',
                     ...
                     'PConnect'  => 'Da PERSISTENT_CONNECTION=TRUE konfiguriert ist, können Aktionen scheitern.',
                     'Rescind'   => 'Herunterfahren abbrechen',
                     'BTarget'   => 'Sichern nach',
                     'FDName'    => 'Datei- oder Gerätename',
                     'ServiceMgr'=> 'Service Manager',
                     'BlFactor'  => 'Blocking Faktor',
                     'Options'   => 'Optionen',
                     'BConvert'  => 'externe Dateien in interne Tabellen umwandeln',
                     'BCreate'   => 'nichtkomprimierte Sicherung erstellen',
...
$MESSAGES = array('BLOB_BROKEN_INFO'      => "Die Blob-Funktionen sind defekt (zumindest in php4.0.2 und php4.0.3).<br>\n"
                  ...
                  'DELETE_CON_DB'         => "Eine Datenbank in Verwendung kann nicht gelöscht werden. Nun ist ibWebAdmin nicht mehr mit %s verbunden.<br>\n"
