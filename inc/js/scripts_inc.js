...
function showWaitScreen(message) {
	...
	if (document.Form.page_status) 
		{
		document.Form.page_status.value='searching';
		}
	...
	if (browser == "MO") {
		//topPos += 80 ;
		leftPos = (parentWidth/2) - (childWidth/2) ;
		topPos = (parentHeight/2) - (childHeight/2) ;
	...
	childWin = window.open('standby.php?msg=' + escape(message), '', 
